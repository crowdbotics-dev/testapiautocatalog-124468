...
## Project Structure
    ...
    ├── testapiautocatalog_124468  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_124468`
...
2. Clone this repo and `cd testapiautocatalog_124468`
